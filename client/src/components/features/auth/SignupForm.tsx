// client/src/components/features/auth/SignupForm.tsx
      ...
      <form onSubmit={handleSignupSubmit}>
        ...
        <CardFooter>
          ...
          <div className="flex justify-end gap-2 w-full">
            ...
            <Button
              type="submit"
              className="w-28 h-9 bg-black text-white hover:bg-blue-700 font-bold dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200 transition-colors text-sm"
              disabled={isLoading}
            >
